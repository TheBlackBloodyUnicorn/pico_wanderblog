...
class FrontController{
	function __construct() {
		...
		*/
		$actionsAdministrator = array(NULL,"home","down_vote","up_vote","display_adventure","add_display","add_adventure","profile","all_adventures","comment", "remove_adv");
		$actionsReader = array(NULL,"home","down_vote","up_vote","display_adventure","profile", "all_adventures","comment");
		$actionsVisitor = array(NULL,"home","display_adventure","display_sign_up","sign_up","all_adventures");
		$actionsAuthor = array(Null, "home","down_vote","up_vote","display_adventure","add_display", "add_adventure", "profile","all_adventures","comment","remove_adv");
